...
| Date filter     | Enter a from date                                 | Articles filtered from that date                              | Pass   | ![Enter From Date](assets/images/from_to_oldest.png)Pass           |      |
| Date filter     | Enter a to date                                   | Articles filtered up to that date                             | Pass   | ![Enter to Date](assets/images/from_to_oldest.png)Pass             |      |
| Sort            | Select "Oldest First"                             | Articles reorder oldest first                                 | Pass   | ![Oldest First](assets/images/from_to_oldest.png)Pass              |      |
| Sort            | Select "Relevance"                                | Articles reorder by relevance                                 | Pass   | ![Most Relevant](assets/images/most_relevant.png)Pass              |      |
| Load More       | Click Load More button                            | Next page of articles appended                                | Pass   | ![Load More Results](assets/images/load_more_before_after.png)Pass |      |
